...
const Checkoutold = () => {
  ...
  const [currentStep, setCurrentStep] = useState("cart"); // Add this new state
  ...
  return (
    <div className="checkout">
      <div className="checkout-container" data-step={currentStep}>
        ...
        <div className="step-navigation">
          ...
          {currentStep !== "shipping-payment" ? (
            ...
            <button className="step-button pay" onClick={handlePayClick}>
              Pay Now
            </button>
          )}
        </div>
